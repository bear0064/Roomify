                    ...
                    <div class="nav navbar-nav">                        
                        <div class="inner-header">
                            ...
                            <ul class="comments">
                                ...
                                <li class="not-sp"><a href="homeowner-profile.php">Profile</a></li>
            ...
            <div class="modal fade" id="contestModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content row">
                        <div class="col-md-2 prog-bar nopadding" style="height:100%;">
                            <ul class="progress-indicator stepped stacked nocenter resp-tabs-list">
                                <li class="completed">
