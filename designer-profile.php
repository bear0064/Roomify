...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="js/libs/tabs/easy-responsive-tabs.css">
        <!-- Fonts -->
    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-faded">
            <div class="navbar-toggler hidden-sm-up" type="button" data-toggle="collapse" data-target="#exCollapsingNavbar2">
            &#9776;
                <div class="logo navbar-brand logo-sp">
                    <a href="index.php">
            ...
            <div id="exCollapsingNavbar2" class="header collapse navbar-toggleable-xs">
                <div class="navbar-inner">
                    <div class="logo navbar-brand logo-pc">
                        <a href="index.php">
                            <img src="img/footer-logo.svg" width="50">
                        </a>
                    </div>
                    <div class="nav navbar-nav">                        
                        <div class="inner-header">
                            ...
                            <ul class="comments">
                                ...
                                <li class="mes-sp"><a href="#">Message</a></li>
                                <li><a href="#"><i class="fa fa-bell-o"></i></a></li>
                                <li class="not-sp"><a href="#">Notification</a></li>
                                <li class="not-sp"><a href="designer-profile.php">Profile</a></li>
                                <li class="not-sp"><a href="#">Settings</a></li>
                                <li class="not-sp"><a href="api/logout.php">Logout</a></li>
                            </ul>
                        </div>
                        <div class="pull-right">
                            <ul class="nav">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="https://media.licdn.com/mpr/mprx/0_PtRfS_1jZSA_l5eJznS3_lMjyw1GlXXLPniTe9cpZ23_qqsMAKi76_VpR2A_qLcdsi77L5zyr2CiBhLvx3O15BZKv2CCBhOMp3O2mnSgYDBag9LLKKeCaG_uzMZtOhWevCsidXwiO9W" class="avatar img-circle img-thumbnail img-thumbnail-custom" alt="avatar"><i class="fa fa-chevron-down"></i></a>
                    ...
                    <div class="col-xs-12">
                        <div class="media">
                            <div class="pull-left" href="#">
                                <img class="media-object img-circle img-thumbnail img-thumbnail-custom" src="https://media.licdn.com/mpr/mprx/0_PtRfS_1jZSA_l5eJznS3_lMjyw1GlXXLPniTe9cpZ23_qqsMAKi76_VpR2A_qLcdsi77L5zyr2CiBhLvx3O15BZKv2CCBhOMp3O2mnSgYDBag9LLKKeCaG_uzMZtOhWevCsidXwiO9W" alt="avatar" style="width: 125px;height:125px;">
                            </div>
                            <div id="profile" class="media-body" style="padding-left: 20px"><br><p><span class="name">Doan Khanh</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><p>English, French<br>CA</p></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="horizontalTab">
            ...
            <div class="tabs">
                <div class="container">
                    <ul class="nav nav-pills resp-tabs-list">
            ...
            <div class="container">
                <div class="tab-content resp-tabs-container">
                    ...
                    <div id="about" class="tab-pane fade cnt-center">
                        ...
                        <!-- Stats -->
                        <div class="count-number col-sm-12 col-md-10 col-md-offset-1">
        ...
        <script src="js/libs/tabs/easy-responsive-tabs.js"></script>
