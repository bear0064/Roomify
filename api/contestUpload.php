...
$sqlQuery = 'INSERT INTO `projects`(`project_title`, `project_desc`, `closing_date`, `creator_id`, `state`, `prize`) VALUES ("'.$proj_title.'","'.$proj_desc.'","'.$endDate.'",'.$proj_creator.', 1 ,'.$proj_prize.')';
